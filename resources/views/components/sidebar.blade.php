<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown">
        <a href="/interview" class="nav-link"><i data-feather="monitor"></i><span>Interview</span></a>
      </li>
      <li class="dropdown">
        <a href="/rachana" class="nav-link"><i data-feather="monitor"></i><span>Lekh Rachana Form</span></a>
      </li>
      <li class="dropdown">
